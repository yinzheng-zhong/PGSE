...
#SBATCH --export=ALL
#SBATCH -J pgse
#SBATCH -p lowpriority           # Ensure this is the correct partition
#SBATCH -o slurm-xgb-%A_%a.out
#SBATCH --ntasks=1
...
python3 main-xgb.py \
        ...
        --save-file "../volatile/var/${COMPOUND}-k11.save" \
        --export-file "../volatile/var/result-${COMPOUND}-k11" \
