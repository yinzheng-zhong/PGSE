...
R `PGSE` is primarily a wrapper around the [`pgse`](https://github.com/yinzheng-zhong/PGSE/) Python package. It has a set of S3 implementations to allow seamless use in R. An low-level wrapper around the Python training and inference pipelines is also provided.

## Installation

You can install the development version of PGSE from [GitHub](https://github.com/) with:
...
# specific gene ACATGAGTACCA, which is associated with a high MIC
